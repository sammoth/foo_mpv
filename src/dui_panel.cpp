...
struct dui_panel_window : public ui_element_instance,
 ...
 public:
  ...
  dui_panel_window(ui_element_config::ptr config,
  ...
  static GUID g_get_guid() { return guid_dui_panel; }
...
class ui_element_mpvimpl : public ui_element_impl<dui_panel_window> {};
